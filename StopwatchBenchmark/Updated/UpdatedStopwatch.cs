...
namespace StopwatchBenchmark
{
    ...
    public partial class UpdatedStopwatch
    {
        ...
        public UpdatedStopwatch()
        {
        }

        private UpdatedStopwatch(long initialState)
        {
            _state = initialState;
        }
        ...
        public static UpdatedStopwatch StartNew()
        {
            long initialState = GetTimestamp();
            UpdatedStopwatch s = new UpdatedStopwatch(initialState);
            return s;
        }
